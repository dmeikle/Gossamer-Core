...
class Router
{
    use \Gossamer\Core\Routing\Configuration\Traits\LoadConfigurationTrait;
    ...
    public function getCurrentNode() {
        ...
        $nodeConfig['componentPath'] = str_replace('config/' . $this->getRoutingFileName(), '', $initialRoutingPath);
